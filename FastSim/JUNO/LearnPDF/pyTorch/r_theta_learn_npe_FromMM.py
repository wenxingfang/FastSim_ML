...
def get_parser():
    ...
    parser.add_argument('--KitModelPath', action='store', type=str, default="",
                        help='KitModelPath')
...
if __name__ == '__main__':
    ...
    '''
    #sys.path.append('/hpcfs/juno/junogpu/fangwx/FastSim/JUNO/LearnPDF/pyTorch/MMdnnFile/ori_tf_files')
    ...
    if saveToCPU:
        ...
        torch.save(net, pt_file_path.replace('.pt','_full.pt'))
    print('done')
