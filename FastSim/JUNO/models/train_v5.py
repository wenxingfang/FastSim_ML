...
file: train_v5.py
##########################################################
Input image is theta(124)*phi(360) for time and nPE of PMT
###########################################################
"""
...
if __name__ == '__main__':
    ...
    from architectures import build_generator, build_discriminator, build_generator_v1, build_generator_v2,build_generator_v3,build_generator_v4, build_discriminator_v1, build_discriminator_v2,build_discriminator_v3, build_discriminator_v4, build_generator_v5
    ...
    #calorimeter = [Input(shape=sizes[:2] + [1]), Input(shape=sizes[2:4] + [1])]
    calorimeter = Input(shape=(124,360,1))
