...
if __name__ == '__main__':
    ...
    reg  = Dense(4, activation='tanh',  name='muon_info_output')(features)
    #reg  = Dense(5, activation='tanh',  name='muon_info_output')(features)
    #reg  = Dense(5, name='muon_info_output')(features)
