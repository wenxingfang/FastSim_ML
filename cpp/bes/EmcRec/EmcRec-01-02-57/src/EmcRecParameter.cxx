...
double EmcRecParameter::BarrShLogThetaPara(int n , int m) const
{
  return barrShLogThetaPara[n][m];
}

double EmcRecParameter::BarrShLogPhiPara(int n ,int m) const
{
  return barrShLogPhiPara[n][m];
}
