...
//  }
//    std::cout<<"PositionMode1="<<Para.PositionMode1()<<std::endl;
...
{
   //std::cout<<"Hi EmcRecSplitWeighted"<<std::endl;
  ...
  // only one seed or second moment belows cut
    ...
    //std::cout<<"Hi EmcRecSplitWeighted 1"<<std::endl;
    aShower.Clear();
    aShower.setStatus(1);
    // ID
    ...
    if(time>=Para.TimeMin()&&time<=Para.TimeMax()) {
      ...
      //std::cout<<"Hi aShower.setTime"<<std::endl;
      aShower.setTime(time);
      //std::cout<<"Hi fShowerE"<<std::endl;
      fShowerE->Energy(aShower);
      //std::cout<<"Hi fShowerPos"<<std::endl;
      fShowerPos->Position(aShower);
      //std::cout<<"Hi fShowerShape"<<std::endl;
      fShowerShape->CalculateMoment(aShower);
      //std::cout<<"Hi ThetaGap"<<std::endl;
      aShower.ThetaGap(9);
      //std::cout<<"Hi PhiGap"<<std::endl;
      aShower.PhiGap(9);
      // push it into map
      aShowerMap[aMaxVec[0]]=aShower;
    }
    //std::cout<<"Hi EmcRecSplitWeighted 11"<<std::endl;
  }


  // two or more seeds and second moment beyonds cut
  else if(aMaxVec.size()>1&&aMaxVec.size()<=20&&aCluster.getSecondMoment()>cut) {
    //std::cout<<"Hi EmcRecSplitWeighted 2"<<std::endl;
    ...
    do {
      //std::cout<<"Hi EmcRecSplitWeighted 3"<<std::endl;
      centroidShift=0.;
      tmpShowerMap.clear();
      for(ciMax=aMaxVec.begin();
          ciMax!=aMaxVec.end();
      ...
      //std::cout<<"aMaxVec.size()="<<aMaxVec.size()<<std::endl;
      centroidShift/=(double)aMaxVec.size();
      //std::cout<<"centroidShift="<<centroidShift<<std::endl;
    ...
    for(i_ShowerMap=tmpShowerMap.begin();
	      ...
	      ++i_ShowerMap) {
      //std::cout<<"Hi EmcRecSplitWeighted 4"<<std::endl;
