...
class EmcRecParameter
{
  ...
  public:
    ...
    inline void SetBarrShLogThetaPara(double p,int n,int m) { barrShLogThetaPara[n][m]=p; }
    inline void SetBarrShLogPhiPara(double p,int n,int m) { barrShLogPhiPara[n][m]=p; }
