...
inFileName ='signal-evt-80010-3.root'
outFileName='data.h5'
treeName='evt'
...
#print (nRows)
firstHitTimeByPMT = np.full((totalEntries, nRows, nCols), -100)#init 
nPEByPMT          = np.full((totalEntries, nRows, nCols), -1000)#init 
