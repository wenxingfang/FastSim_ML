...
out_path = '/junofs/users/wxfang/FastSim/bes3/workarea/TestRelease/TestRelease-00-00-86/DedxTest/sim/job_NN/'
for i in range(N_file):
    f_out =open(out_path+'job_%d.txt'%i,'w')
    for line in lines:
        if 'RootCnvSvc.digiRootOutputFile' in line:
            line = line.replace('dummy','/junofs/users/wxfang/FastSim/bes3/workarea/TestRelease/TestRelease-00-00-86/DedxTest/sim/output_NN/Single_pp_NN_%d.rtraw'%i)
            f_out.write(line)
