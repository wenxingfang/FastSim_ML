...
sim_dir = '/junofs/users/wxfang/FastSim/bes3/workarea/TestRelease/TestRelease-00-00-86/DedxTest/sim/output_off/'
...
out_path = '/junofs/users/wxfang/FastSim/bes3/workarea/TestRelease/TestRelease-00-00-86/DedxTest/rec/job_off/'
seed = 100
index = 0
for i in sim_file:
    seed = seed + 1
    ...
    for line in lines:
        if 'EventCnvSvc.digiRootOutputFile' in line:
            line = line.replace('dummy.rec','/junofs/users/wxfang/FastSim/bes3/workarea/TestRelease/TestRelease-00-00-86/DedxTest/rec/output_off/%s.rec'%i)
            f_out.write(line)
