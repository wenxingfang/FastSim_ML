...
class Obj:
    def __init__(self, name, fileName, max_evt):
        ...
        self.h_rec_E          = rt.TH1F('%s_h_rec_E'        %(str_ext) ,'',100,0.8,1.2)
        self.h_rec_E_res      = rt.TH1F('%s_h_rec_E_res'    %(str_ext) ,'',120,-0.3,0.3)
...
out_root ='Matrix_1GeV_out.root' 
reco_root_out = 'Matrix_1GeV_reco_eff.root'
#obj_pan        = Obj('MatrixPfo','/cefs/higgs/wxfang/cepc/Pandora/Ana/gamma/Ana_gamma_Matrix_1GeV_0602.root', 1000000)
