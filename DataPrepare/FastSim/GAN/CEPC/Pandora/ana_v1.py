...
#out_root ='full%s_out.root'%(str_re)
#reco_root_out = 'full%s_reco_eff.root'%(str_re)
#obj_pan        = Obj('PanPfo','/cefs/higgs/wxfang/cepc/Pandora/Ana_da_pid/gamma/reco_sim_*.root', 1000000)
...
#obj_pan        = Obj('PanPfo','/cefs/higgs/wxfang/cepc/Pandora/AnaCalo/gamma/plcio/Digi_sim*.root', 1000000)
out_root ='k4calo_out.root' 
reco_root_out = 'k4calo_reco_eff.root'
obj_pan        = Obj('k4PanPfo','/cefs/higgs/wxfang/cepc/Pandora/AnaCalo/gamma/k4FWCore/Digi_sim*_k4FWCore.root', 1000000)
str_led_pa = "#gamma"
