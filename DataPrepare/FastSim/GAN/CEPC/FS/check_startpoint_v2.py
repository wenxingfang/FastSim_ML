...
if __name__ == '__main__':
    ...
    ForNotFind = False
    only_stave_1 = True  ##not used
    only_stave_2 = False## not used
    ...
    print (total_evt)
    h_em_point_x  = rt.TH1F('em_point_x'     , '', 160, 1850, 2010)
    h_em_point_y  = rt.TH1F('em_point_y'     , '', 800, -800, 800)
    h_em_point_z  = rt.TH1F('em_point_z'     , '', 240, -2400, 2400)
    h_em_Mom      = rt.TH1F('em_mom'         , '', 110, 0, 1100)
    h_em_theta    = rt.TH1F('em_mom_theta'   , '', 180, 0, 180)
    h_em_phi      = rt.TH1F('em_mom_phi'     , '', 180, -90, 90)
    h_ep_point_x  = rt.TH1F('ep_point_x'     , '', 160, 1850, 2010)
    h_ep_point_y  = rt.TH1F('ep_point_y'     , '', 800, -800, 800)
    h_ep_point_z  = rt.TH1F('ep_point_z'     , '', 240, -2400, 2400)
    h_ep_Mom      = rt.TH1F('ep_mom'         , '', 110, 0, 1100)
    h_ep_theta    = rt.TH1F('ep_mom_theta'   , '', 180, 0, 180)
    h_ep_phi      = rt.TH1F('ep_mom_phi'     , '', 180, -90, 90)
    total_evt = tree.GetEntries()
    #total_evt = 400#int(total_evt/100.0)
