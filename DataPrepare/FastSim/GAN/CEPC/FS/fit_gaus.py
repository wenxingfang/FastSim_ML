...
if __name__ == '__main__':
    ...
    str_f_in  = 'G4_out.root'
    str_f_out = 'G4_res.root'
    if isFS:
        str_f_in  = 'FS_out.root'
        str_f_out = 'FS_res.root'
    if isBarrel == False:
        str_f_in  = 'G4_Endcap_out.root'
        str_f_out = 'G4_Endcap_res.root'
        if isFS:
            str_f_in  = 'FS_Endcap_out.root'
            str_f_out = 'FS_Endcap_res.root'
    f_in = rt.TFile(str_f_in ,'read'    )
    f_out= rt.TFile(str_f_out,'RECREATE')

    fit_range_dict = {}
    fit_range_dict['E_70_80_Theta'] = [-0.04, 0.04]
    if False:
    ...
    if isFS and False:
        fit_range_dict['Phi_0_10_E']       = [-0.07, 0.05]
        fit_range_dict['Phi_-10_0_E']      = [-0.07, 0.05]
        fit_range_dict['Phi_10_20_E']      = [-0.07, 0.05]
        fit_range_dict['Phi_-20_-10_E']    = [-0.07, 0.05]
        fit_range_dict['Phi_20_30_E']      = [-0.07, 0.05]
        fit_range_dict['Phi_-30_-20_E']    = [-0.07, 0.05]
        fit_range_dict['Phi_30_40_E']      = [-0.07, 0.05]
        fit_range_dict['Phi_-40_-30_E']    = [-0.07, 0.05]
        fit_range_dict['Phi_40_50_E']      = [-0.07, 0.05]
        fit_range_dict['Phi_-50_-40_E']    = [-0.07, 0.05]
        fit_range_dict['Phi_50_60_E']      = [-0.07, 0.05]
        fit_range_dict['Phi_-60_-50_E']    = [-0.07, 0.05]
        fit_range_dict['Phi_-70_-60_E']    = [-0.07, 0.05]
        fit_range_dict['Phi_60_70_E']      = [-0.07, 0.05]
        fit_range_dict['Phi_70_80_E']      = [-0.07, 0.05]
        fit_range_dict['Phi_-80_-70_E']    = [-0.07, 0.05]
        fit_range_dict['Phi_80_90_E']      = [-0.07, 0.05]
        fit_range_dict['Phi_-90_-80_E']    = [-0.07, 0.05]
        fit_range_dict['Phi_0_10_Phi']     = [-0.04, 0.06]
        fit_range_dict['Phi_-10_0_Phi']    = [-0.04, 0.06]
        fit_range_dict['Phi_10_20_Phi']    = [-0.04, 0.06]
        fit_range_dict['Phi_-20_-10_Phi']  = [-0.04, 0.06]
        fit_range_dict['Phi_30_40_Phi']    = [-0.04, 0.06]
        fit_range_dict['Phi_-40_-30_Phi']  = [-0.04, 0.06]
        fit_range_dict['Phi_50_60_Phi']    = [-0.04, 0.06]
        fit_range_dict['Phi_-60_-50_Phi']  = [-0.04, 0.06]
        fit_range_dict['Phi_70_80_Phi']    = [-0.04, 0.06]
        fit_range_dict['Phi_-80_-70_Phi']  = [-0.04, 0.06]
        fit_range_dict['Phi_-90_-80_Phi']  = [-0.04, 0.06]
        fit_range_dict['Theta_50_60_E']    = [-0.07, 0.05]
        fit_range_dict['Theta_60_70_E']    = [-0.07, 0.05]
        fit_range_dict['Theta_70_80_E']    = [-0.07, 0.05]
        fit_range_dict['Theta_80_90_E']    = [-0.07, 0.05]
        fit_range_dict['Theta_90_100_E']   = [-0.07, 0.05]
        fit_range_dict['Theta_100_110_E']  = [-0.07, 0.05]
        fit_range_dict['Theta_110_120_E']  = [-0.07, 0.05]
        fit_range_dict['Theta_120_130_E']  = [-0.07, 0.05]
        fit_range_dict['Theta_50_60_Theta']= [-0.05, 0.05]
        fit_range_dict['E_0_10_Theta'] = [-0.05, 0.05]
        fit_range_dict['E_10_20_Theta'] = [-0.05, 0.05]
        fit_range_dict['E_20_30_Theta'] = [-0.05, 0.05]
        fit_range_dict['E_30_40_Theta'] = [-0.05, 0.05]
        fit_range_dict['E_40_50_Theta'] = [-0.05, 0.05]
        fit_range_dict['E_50_60_Theta'] = [-0.05, 0.05]
        fit_range_dict['E_60_70_Theta'] = [-0.05, 0.05]
        fit_range_dict['E_70_80_Theta'] = [-0.05, 0.05]
        fit_range_dict['E_80_90_Theta'] = [-0.05, 0.05]
        fit_range_dict['E_90_95_Theta'] = [-0.05, 0.05]
        fit_range_dict['E_95_100_Theta'] = [-0.05, 0.05]
        fit_range_dict['E_0_10_E']  = [-0.07, 0.05]
        fit_range_dict['E_10_20_E'] = [-0.07, 0.05]
        fit_range_dict['E_20_30_E'] = [-0.07, 0.05]
        fit_range_dict['E_30_40_E'] = [-0.07, 0.05]
        fit_range_dict['E_40_50_E'] = [-0.07, 0.05]
        fit_range_dict['E_50_60_E'] = [-0.07, 0.05]
        fit_range_dict['E_60_70_E'] = [-0.07, 0.05]
        fit_range_dict['E_70_80_E'] = [-0.07, 0.05]
        fit_range_dict['E_80_90_E'] = [-0.07, 0.05]
        fit_range_dict['E_90_95_E'] = [-0.07, 0.05]
        #fit_range_dict['E_80_90_Phi'] = [-0.03, 0.04]
        #fit_range_dict['E_90_95_Phi'] = [-0.03, 0.04]
    if isFS==False:
        fit_range_dict['E_60_70_E'] = [-0.05, 0.05]
        fit_range_dict['E_70_80_E'] = [-0.05, 0.05]
        fit_range_dict['E_80_90_E'] = [-0.05, 0.05]
    ...
    for ih in range(0,f_in.GetListOfKeys().GetSize()):
        ...
        if "_E" in hname:
            lower  = mean - 1.5*rms
            higher = mean + 1.5*rms
        if "_Theta" in hname and 'E_' in hname and isBarrel==False:
            #E_30_40_Theta
            #print('hi %s'%hname)
            lower  = mean - 2.5*rms
            higher = mean + 2.5*rms
