...
class Obj:
    def __init__(self, name, fileName, max_evt, outfile):
        ...
        self.h_rec_theta      = rt.TH1F('%s_h_rec_theta'    %(str_ext) ,'',180,0,180)
        #self.h_rec_phi        = rt.TH1F('%s_h_rec_phi'      %(str_ext) ,'',phi_bins, -90 ,90)
        self.h_rec_phi        = rt.TH1F('%s_h_rec_phi'      %(str_ext) ,'',phi_bins, -180 ,180)
...
G4_out ='G4%s_out.root'%(str_re)
#obj_G4        = Obj('G4','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/G4/*.root', 1000000, G4_out)

obj_G4        = Obj('G4','/cefs/higgs/wxfang/cepc/FS/Endcap_G4_digi/*.root', 1000000, G4_out)
FS_out   ='FS_out.root' 
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/em/FS/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/em/*0418.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/em/*0421.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_gap/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_gap_e/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_gap_e_cellcenter/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_faiss/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_faiss_0518/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_faiss_0518_cCenter/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_faiss_0525_cCenter/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_faiss_ExtendX_0526/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_Force/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_Force_dmin_10/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_Force_L2/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_Force_Y/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_Force_Y_addNoFind/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_Force_Y_addNoFind_0624/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_Force_Escale_0626/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/Pandora/AnaCaloFS/gamma/FS_sp_Force_All_0628/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/FS/EnScale_apply_digi/*.root', 1000000, FS_out)
#obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/FS/EnScale_apply_v1_digi/*.root', 1000000, FS_out)

obj_FS        = Obj('FS','/cefs/higgs/wxfang/cepc/FS/Endcap_noFound_digi/*.root', 1000000, FS_out)
str_led_pa = "#gamma"
reco_root_out = 'reco_eff.root'

obj_G4.fill()
obj_FS.fill()
ScaleToG4=True
print('saved G4=',obj_G4.h_rec_E.GetSumOfWeights(),',FS =',obj_FS.h_rec_E.GetSumOfWeights())
do_plot_g2(obj_G4.h_rec_E    , obj_FS.h_rec_E    , 'Pan_reco_E', {'X':"E_{pfo}^{%s} GeV"%str_led_pa,'Y':'Events'}, '', ScaleToG4)
do_plot_g2(obj_G4.h_rec_theta, obj_FS.h_rec_theta, 'Pan_reco_theta', {'X':"#theta_{pfo}^{%s} degree"%str_led_pa,'Y':'Events'}, '', ScaleToG4)
do_plot_g2(obj_G4.h_rec_phi  , obj_FS.h_rec_phi  , 'Pan_reco_phi'  , {'X':"#phi_{pfo}^{%s} degree"%str_led_pa,'Y':'Events'}, '', ScaleToG4)
'''
