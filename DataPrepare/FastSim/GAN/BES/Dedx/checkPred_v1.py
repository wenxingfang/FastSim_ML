...
if __name__ == '__main__':
    ...
    const_mom_scale = 1
    '''
    #file_in.append('/hpcfs/juno/junogpu/fangwx/FastSim/BES/Dedx/electron/Pred/Pred_em_100K_k500_D1e-1_ltail.h5')
    file_in.append('/hpcfs/juno/junogpu/fangwx/FastSim/BES/Dedx/electron/Pred/Pred_em_twoSP.h5')
    const_scale = 228#3*32 
    const_shift = 638#546
    const_mom_scale = 2
    #file_in.append('/hpcfs/juno/junogpu/fangwx/FastSim/BES/Dedx/electron/Pred/Pred_em_100K_k500_D1e-1_SNet1.h5')
    #file_in.append('/hpcfs/juno/junogpu/fangwx/FastSim/BES/Dedx/electron/Pred/Pred_em_100K_k500_D1e-1_ltail.h5')
    #file_in.append('/hpcfs/juno/junogpu/fangwx/FastSim/BES/Dedx/electron/Pred/Pred_em_100K_k500_D1e-1_SNet.h5')
    #file_in.append('/hpcfs/juno/junogpu/fangwx/FastSim/BES/Dedx/electron/Pred/Pred_em_100K_k500_D1e-1.h5')
    #file_in.append('/hpcfs/juno/junogpu/fangwx/FastSim/BES/Dedx/electron/Pred/Pred_em_barrel.h5')
    #file_in.append('/hpcfs/juno/junogpu/fangwx/FastSim/BES/Dedx/electron/Pred/Pred_em_endcap_2.h5')
    df = None
    First = True
    for i in  file_in:
        hf = h5py.File(i, 'r')
